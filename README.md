...
- **LLM orchestration**: LangChain (LCEL runnables), Google's free-tier `gemini-3.5-flash` via `langchain-google-genai`. (`gemini-2.0-flash` was shut down by Google on June 1, 2026 — don't use it.)
